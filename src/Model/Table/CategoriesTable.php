...
class CategoriesTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        /**
         * Solo se puede usar el id
         */
        $this->setPrimaryKey('id');

        $this->addBehavior('Timestamp');
        /**
         * TreeBehavior fue agregado a CategoriesTable en el método initialize().
         */
        
        $this->addBehavior('Tree');
       
        /**
         * Propiedad que se usa para poder ligar categorias padres con categorias hijas.
         */
